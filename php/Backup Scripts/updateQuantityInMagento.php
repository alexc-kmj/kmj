...
// removed CPP from drop ship list 3-23
// removed DEI from drop ship list 4-7
// removed FLE from drop ship list 7-18
// removed VDO from drop ship list 8-4
/**********Array of PLCs that are drop shipped to check against**********/
$plc_array = array("ACC", "ACL", "ALL", "ARA", "ARC", "ARP", "AVS", "BLM", "BMM", "BRU", "CGT", "DGH", "DHA", "DUR", "ELG", "FEL", "FLO", "FMP", "FRA", "GFS", "GFU", "HAS", "HOW", "HSK", "HUR", "HYT", "JBA", "JET", "KEV", "KMJ", "KRC", "LND", "MDN", "MEL", "MIC", "MOT", "NOR", "PAC", "PEP", "PNR", "PPG", "PRB", "PRP", "PRW", "PTX", "PWM", "QTI", "QUI", "RAC", "RHS", "SAG", "SCA", "SCT", "STA", "TIM", "TRX", "ULT");
echo 'Created Array' . "\r\n";
