...
// removed FIT from drop ship list 6-7-17
// removed PRP from drop ship list 7-14-17
// removed JET from drop ship list 7-25-17
// added PRO to drop ship list 8-01-17
// removed PRB from drop ship list 9-14-17
// added FST to drop ship list 11-16-17
// removed BRG from drop ship list 11-24-17
// added SPD to drop ship list 12-29-17
// removed FRA from drop ship list 2-4-18
// removed ARC, ARP from drop ship list 3-19-18
// removed FMP, GFU, AVS, BLM, LND, RNL, STA, FLO, BMM, HUR from drop ship list 3-29-18

/**********Array of PLCs that are drop shipped to check against**********/
$plc_array = array("ACC", "ACL", "AES", "ALL", "ARA", "ATC", "BRU", "CGT", "DGH", "DHA", "DUR", "EDG", "EIB", "ELG", "FEL", "FST", "GFS", "GRF", "HAS", "HOW", "HSK", "HYT", "JBA", "KEV", "KMJ", "KNN", "KRC", "MDN", "MEL", "MIC", "MOT", "MSD", "NOR", "PAC", "PEP", "PNR", "PPG", "PRO", "PRW", "PTX", "PWM", "QTI", "QUI", "RAC", "RDL", "RHS", "ROF", "SAG", "SCA", "SCT", "SPD", "SWE", "TIM", "TRX", "ULT", "WIS");
echo 'Created Array' . "\r\n";
