...
CSV_TO_READ = 'StateExclusions.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"INSERT INTO ImasterShippingExcludedState (PartID, StateCode) VALUES (?, 'AK')", PartID)

    print (PartID + ' --> HI'   )
    run_sql_statement(ODBC_CONN,"INSERT INTO ImasterShippingExcludedState (PartID, StateCode) VALUES (?, 'HI')", PartID)
