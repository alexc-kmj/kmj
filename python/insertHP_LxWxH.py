...
def run_sql_statement(ODBC_CONN,SQL,SQL_VAR_1,SQL_VAR_2,SQL_VAR_3,SQL_VAR_4):
    #set cursor for connection
    CUR_OBJ = ODBC_CONN.cursor()
    print ('cursor created')
    #execute SQL statement
    CUR_OBJ.execute(SQL, (SQL_VAR_1, SQL_VAR_2, SQL_VAR_3, SQL_VAR_4))
    print ('update ran')
    ODBC_CONN.commit()
    print ('committed')
...
CSV_TO_READ = 'insert_PartIDLWH.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"INSERT INTO ImasterEcommerce (PartID, Length, Width, Height) VALUES ( ?, ?, ?, ?)", PartID, Length, Width, Height)
