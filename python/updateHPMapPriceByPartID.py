...
CSV_TO_READ = 'MapPriceByPartID.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    print (PartID + ' --> ' +  str(MapPrice_float))
    ...
    run_sql_statement(ODBC_CONN,"UPDATE ImasterECommerce SET MapPrice = ? FROM ImasterECommerce WHERE PartID = ?",MapPrice_float,PartID)
