...
CSV_TO_READ = 'PartIDLWH.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"UPDATE ImasterEcommerce SET Length = ?, Width = ?, Height = ? WHERE PartID = ?", Length, Width, Height, PartID)
