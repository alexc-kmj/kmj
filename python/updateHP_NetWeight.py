...
#Update NetWeight in HP for the Dim Weight              #
...
CSV_TO_READ = 'NetWeight_PartID.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"UPDATE Imaster SET NetWeight = ? FROM Imaster WHERE PartID = ? ", Weight, PartID)
