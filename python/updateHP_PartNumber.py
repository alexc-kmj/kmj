...
CSV_TO_READ = 'PartNumber.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"UPDATE Imaster SET PartNumber = ? FROM Imaster WHERE Imaster.PartID = ?", PartNumber, PartID)
