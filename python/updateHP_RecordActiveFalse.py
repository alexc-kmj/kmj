...
CSV_TO_READ = 'RecordActive.csv'     # This assumes your SKUs are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"UPDATE Imaster SET RecordActive = FALSE FROM Imaster WHERE Imaster.PartID = ?", PLC)
