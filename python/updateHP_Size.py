...
CSV_TO_READ = 'PartIDSize.csv'  # This assumes your part numbers are in the first column
...
for row in csv_Amazon:
    ...
    run_sql_statement(ODBC_CONN,"UPDATE Imaster SET Size = NULL WHERE PartID = ?", PartID)
